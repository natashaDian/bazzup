...
// ---------------------------------------------------------------------------
// Vendor-facing: powers the vendor's own "Application Status" page
// (app/(vendor)/applications), where a vendor tracks the bazaars they've
// applied to.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Organizer-facing: powers the organizer applications board and detail pages
// (app/(organizer)/organizer/applications, .../vendors/[vendorId]), where an
// organizer reviews who applied to their bazaars.
// ---------------------------------------------------------------------------
